...
// same content.
//
//go:embed gx.md gx-local-tracker.md gx-to-tickets gx-tdd gx-implement gx-resolving-merge-conflicts gx-investigate gx-cleanup gx-merge gx-code-review gx-changelog gx-bump
var Bundle embed.FS
