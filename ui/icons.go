...
type IconSet struct {
	...
	// than represent an actual directory. Collapsed points up and expanded
	// points right, deliberately distinct from the epic row's own
	// FolderClosed/FolderOpen glyphs.
